...
function SubNavMen() {
  ...
  return (
    <div className="">
      <div className="text-black bg-white lg:shadow-lg inset-0 w-full backdrop-blur-xl  dark:bg-dark-secondHO dark:text-dark-fourH lg:py-4 lg:px-7 lg:flex lg:flex-col lg:h-[480px] gap-3 lg:flex-wrap">
        {mystyleo?.menHoverData?.map((item, index) => (
          <div
            key={index}
