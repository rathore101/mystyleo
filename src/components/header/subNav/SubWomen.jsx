...
function SubWomen() {
  ...
  return (
    <div className="">
      <div className="text-black lg:shadow-xl bg-white dark:bg-dark-secondHO dark:text-dark-fourH lg:py-4 lg:px-7 lg:flex lg:flex-col lg:h-[500px] gap-3 lg:flex-wrap">
