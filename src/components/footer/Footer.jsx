      ...
      <div className="xl:pr-52 xl:pl-44 xl:py-14">
        <div className="xl:flex xl:grid-cols-4 justify-between gap-0">
          <div className="mb-10 xl:mb-0">
            <div className="mb-5 w-44 text-white">Logo</div>
          ...
          <ul className="xl:border-none border-b border-b-[#797979]">
            ...
            >
              ...
              <div className="text-[#797979] xl:hidden">
                {isClick["product"] ? <MinusIcon /> : <PlusIcons />}
              </div>
            </div>

            {mystyleo.footer.product?.map((item, index) => (
              <li
                key={index}
          ...
          <ul className="xl:border-none border-b border-b-[#797979]">
            ...
            >
              Learn
              <div className="text-[#797979] xl:hidden">
                {isClick["learn"] ? <MinusIcon /> : <PlusIcons />}
              </div>
            </div>
            {mystyleo.footer.learn?.map((item, index) => (
              <li
                key={index}
          ...
          <ul className="xl:border-none border-b border-b-[#797979] mb-14 xl:mb-0">
            ...
            >
              Other
              <div className="text-[#797979] xl:hidden">
                {isClick["other"] ? <MinusIcon /> : <PlusIcons />}
              </div>
            </div>
            {mystyleo.footer.other?.map((item, index) => (
              <li
                key={index}
        ...
        {/* <div className="flex flex-wrap justify-center xl:justify-start space-x-4 xl:py-4 mb-6 xl:mb-0">
          {mystyleo?.FooterIcons?.Icons?.map((item) => (
